    ...
    public function getAllData()
    {
        ...
        return datatables($currencies)
            ...
            ->addColumn('action', function ($data) {
                $editRoute      = route('super_admin.setting.languages.edit', $data->id);
                $deleteRoute    = route('super_admin.setting.languages.delete', $data->id);
                $translateRoute = route('super_admin.setting.languages.translate', $data->id);
