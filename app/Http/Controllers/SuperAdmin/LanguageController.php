...
use App\Http\Services\SuperAdmin\LanguageService;
...
class LanguageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super_admin.setting.languages.index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('super_admin.setting.languages.edit-form', $data);
    }
    ...
    public function translateLanguage($id)
    {
        ...
        if (request()->ajax()) {
            return view('super_admin.setting.languages.partials.translations_table', compact(
        ...
        return view('super_admin.setting.languages.translate', array_merge($data, compact(
