...
use App\Http\Services\SuperAdmin\SettingsService;
...
class SettingController extends Controller
{
    ...
    public function configurationSettingHelp(Request $request)
    {
        if ($request->key == 'email_verification_status' || $request->key == 'app_mail_status') {
            ...
            return view('super_admin.setting.general_settings.configuration.help.force_ssl_help');
        }
    ...
    public function logoSettings()
    {
        ...
        return view('super_admin.setting.general_settings.logo-settings')->with($data);
    }
    ...
    public function googleRecaptchaSetting()
    {
        ...
        return view('super_admin.setting.general_settings.google-recaptcha-settings')->with($data);
    }
    ...
    public function cookieSetting()
    {
        ...
        return view('super_admin.setting.general_settings.cookie-settings', $data);
    }
    ...
    public function liveChatSettings()
    {
        ...
        return view('super_admin.setting.features_settings.live-chat-settings', $data);
    }
    ...
    public function googleAnalyticsSetting()
    {
        ...
        return view('super_admin.setting.general_settings.google_analytics_settings', $data);
    }
    ...
    public function securitySettings()
    {
        ...
        return view('super_admin.setting.general_settings.security-settings', $data);
    }
