        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content zModalTwo-content">
                ...
                <form class="ajax reset" action="{{ route('admin.moderators.store') }}" method="post"
                      data-handler="addResponseForModal">
                    @csrf
                    <div class="modal-body zModalTwo-body model-lg">
                        ...
                        <div class="row rg-25">
                            <div class="col-md-6">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap">
                                        <label for="type" class="form-label">{{ __('Moderator Type') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="primary-form-control sf-select-without-search" id="type"
                                                name="type">
                                            <option value="1">{{ __('New') }}</option>
                                            <option value="2">{{ __('From Alumni') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="old-type-input col-md-6">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap">
                                        <label for="alumni" class="form-label">{{ __('Alumni') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="primary-form-control sf-select-without-search" id="alumni"  name="alumni">
                                            <option value="">{{__('Select an alumni')}}</option>
                            ...
                            <div class="new-type-input col-md-6">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap">
