                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="show-logo-wrap">
                                        ...
                                        <input id="logo_app_preloader" class="d-none logo-file-input"
                                               type="file" name="app_preloader" accept="image/*,video/*"/>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="show-logo-wrap">
                                        ...
                                        <p class="title-text">Recommended Size : 140 X 40</p>
                                        <input id="logo_app_logo" class="d-none logo-file-input"
                                               type="file" name="app_logo" accept="image/*,video/*"/>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="show-logo-wrap">
                                        ...
                                        <p class="title-text">Recommended Size : 140 X 40</p>
                                        <input id="logo_app_black_logo" class="d-none logo-file-input"
                                               type="file" name="app_black_logo" accept="image/*,video/*"/>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="show-logo-wrap">
                                        ...
                                        <input id="logo_app_fav_icon" class="d-none logo-file-input"
                                               type="file" name="app_fav_icon" accept="image/*,video/*"/>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="show-logo-wrap">
                                        ...
                                        <input id="logo_login_left_image" class="d-none logo-file-input"
                                               type="file" name="login_left_image" accept="image/*,video/*"/>
        ...
        document.querySelectorAll('.logo-file-input').forEach(function (input) {
            input.addEventListener('change', function (e) {
                ...
                reader.onload = function (ev) {
                    var box = document.querySelector('.clickable-logo[data-input-id="' + input.id + '"]');
                    if (!box) return;
