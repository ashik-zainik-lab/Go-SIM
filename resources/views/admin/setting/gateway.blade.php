            ...
            <div class="dashboard-settings-card has-min-height">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between gap-2">
                        ...
                        <a title="{{ __('Sync missing gateway') }}" href="{{ route('admin.setting.gateway.syncs') }}"
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <div class="fs-12 text-muted">
                                    {{ __('Update gateway credentials and conversion rates.') }}</div>
                            </div>
                        </div>
                        ...
                        <div class="bank-div">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-end">
                                    <button type="button" class="primary_button add-bank" title="{{ __('Add Bank') }}">
