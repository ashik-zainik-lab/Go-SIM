...
<div class="p-30">
    <div class="">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a title="{{__('Sync missing gateway')}}" href="{{ route('admin.setting.gateway.syncs') }}" class="bd-ra-12 bg-cdef84 d-none d-sm-inline-block fs-15 fw-500 hover-bg-one lh-25 px-26 py-1 text-black" onclick="return confirm('Are you sure you want to sync gateways?');">
                    ...
                    <table class="table zTable">
                        <thead>
                            <tr>
                                ...
                                <th><div class="text-center">{{ __('Action') }}</div></th>
                            </tr>
                        </thead>
                        <tbody>
