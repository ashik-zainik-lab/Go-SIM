        ...
        <ul class="nav dashboard_common_tabs" id="destinationTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="regions-tab" data-bs-toggle="tab" data-bs-target="#regions-pane"
                    type="button" role="tab" aria-controls="regions-pane"
                    aria-selected="true">{{ __('Regions') }}</button>
            </li>
            <li class="nav-item" role="presentation">
                    ...
                    <form class="ajax reset modal-form" action="{{ route('super_admin.destinations.regions.store') }}"
                        ...
                        <div class="form-row">
                            <div class="dashboard-form-group">
                                ...
                                <select name="name" required class="select2-activate-with-search"
                                    id="regionNameSelect">
                            ...
                            <div class="dashboard-form-group">
                                ...
                                <select name="code" required class="select2-activate-with-search"
                                    id="regionCodeSelect">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax reset" action="{{ route('super_admin.destinations.countries.store') }}" method="POST"
                    ...
                    @csrf
                    <div class="modal-body coomon-row-gap">
                        <div class="form-row coomon-row-gap">
